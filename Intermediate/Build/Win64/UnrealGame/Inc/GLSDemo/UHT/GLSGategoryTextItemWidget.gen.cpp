...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_GLSDemo_CategoryButtonClickDelegate__DelegateSignature_Statics::NewProp_Button = { "Button", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_GLSDemo_eventCategoryButtonClickDelegate_Parms, Button), Z_Construct_UClass_UGLSGategoryTextItemWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GLSDemo_CategoryButtonClickDelegate__DelegateSignature_Statics::NewProp_Button_MetaData), Z_Construct_UDelegateFunction_GLSDemo_CategoryButtonClickDelegate__DelegateSignature_Statics::NewProp_Button_MetaData) };
...
void FCategoryButtonClickDelegate_DelegateWrapper(const FMulticastScriptDelegate& CategoryButtonClickDelegate, UGLSGategoryTextItemWidget* Button)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGLSGategoryTextItemWidget_GetCategoryName, "GetCategoryName" }, // 1521557347
		{ &Z_Construct_UFunction_UGLSGategoryTextItemWidget_GetGategoryButtonEnabled, "GetGategoryButtonEnabled" }, // 3870186257
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::NewProp_CategoryNameText = { "CategoryNameText", nullptr, (EPropertyFlags)0x001400000008001c, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGLSGategoryTextItemWidget, CategoryNameText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::NewProp_CategoryNameText_MetaData), Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::NewProp_CategoryNameText_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::NewProp_ModelObject = { "ModelObject", nullptr, (EPropertyFlags)0x0024080000002014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGLSGategoryTextItemWidget, ModelObject), Z_Construct_UClass_UGLSCustomCategoryModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::NewProp_ModelObject_MetaData), Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::NewProp_ModelObject_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UUserObjectListEntry_NoRegister, (int32)VTABLE_OFFSET(UGLSGategoryTextItemWidget, IUserObjectListEntry), false },  // 3135978134
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSGategoryTextItemWidget_Statics::InterfaceParams) < 64);
	...
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSGategoryTextItemWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSGategoryTextItemWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSGategoryTextItemWidget, UGLSGategoryTextItemWidget::StaticClass, TEXT("UGLSGategoryTextItemWidget"), &Z_Registration_Info_UClass_UGLSGategoryTextItemWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSGategoryTextItemWidget), 3878463409U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSGategoryTextItemWidget_h_1315678116(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSGategoryTextItemWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSGategoryTextItemWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
