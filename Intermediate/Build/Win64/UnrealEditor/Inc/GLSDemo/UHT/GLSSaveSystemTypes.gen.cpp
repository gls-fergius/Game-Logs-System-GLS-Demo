...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FGLSSaveTabParamsInfo_Statics::NewProp_Params = { "Params", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGLSSaveTabParamsInfo, Params), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGLSSaveTabParamsInfo_Statics::NewProp_Params_MetaData), Z_Construct_UScriptStruct_FGLSSaveTabParamsInfo_Statics::NewProp_Params_MetaData) };
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_WorldType = { "WorldType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGLSSaveTabContext, WorldType), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_WorldType_MetaData), Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_WorldType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_PIEInstance = { "PIEInstance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGLSSaveTabContext, PIEInstance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_PIEInstance_MetaData), Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_PIEInstance_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_TabParamsInfo = { "TabParamsInfo", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGLSSaveTabContext, TabParamsInfo), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_TabParamsInfo_MetaData), Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewProp_TabParamsInfo_MetaData) }; // 472498995
...
template<> GLSDEMO_API UScriptStruct* StaticStruct<FGLSSaveData>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGLSSaveSystemInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGLSSaveSystemInterface_PrepareDataToSave, "PrepareDataToSave" }, // 928582576
		{ &Z_Construct_UFunction_UGLSSaveSystemInterface_RequestApplySave, "RequestApplySave" }, // 828050882
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSSaveSystemInterface_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics::ScriptStructInfo[] = {
		{ FGLSSaveTabParamsInfo::StaticStruct, Z_Construct_UScriptStruct_FGLSSaveTabParamsInfo_Statics::NewStructOps, TEXT("GLSSaveTabParamsInfo"), &Z_Registration_Info_UScriptStruct_GLSSaveTabParamsInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGLSSaveTabParamsInfo), 472498995U) },
		{ FGLSSaveTabContext::StaticStruct, Z_Construct_UScriptStruct_FGLSSaveTabContext_Statics::NewStructOps, TEXT("GLSSaveTabContext"), &Z_Registration_Info_UScriptStruct_GLSSaveTabContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGLSSaveTabContext), 294913346U) },
		{ FGLSSaveData::StaticStruct, Z_Construct_UScriptStruct_FGLSSaveData_Statics::NewStructOps, TEXT("GLSSaveData"), &Z_Registration_Info_UScriptStruct_GLSSaveData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGLSSaveData), 3662667873U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSSaveSystemInterface, UGLSSaveSystemInterface::StaticClass, TEXT("UGLSSaveSystemInterface"), &Z_Registration_Info_UClass_UGLSSaveSystemInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSSaveSystemInterface), 2526510473U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_17784503(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Types_GLSSaveSystemTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
