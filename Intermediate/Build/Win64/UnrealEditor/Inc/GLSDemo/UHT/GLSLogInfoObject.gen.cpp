...
void UGLSLogInfoObject::FOnLogSelected_DelegateWrapper(const FMulticastScriptDelegate& OnLogSelected, UGLSLogInfoObject* Model, bool bSelected)
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UGLSLogInfoObject_GetLogInfo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GLSLogInfoObject_eventGetLogInfo_Parms, ReturnValue), Z_Construct_UScriptStruct_FGLSLogInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGLSLogInfoObject_GetLogInfo_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_UGLSLogInfoObject_GetLogInfo_Statics::NewProp_ReturnValue_MetaData) }; // 3359553873
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGLSLogInfoObject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGLSLogInfoObject_GetLogInfo, "GetLogInfo" }, // 3785489601
		{ &Z_Construct_UFunction_UGLSLogInfoObject_LogSelected, "LogSelected" }, // 230336707
		{ &Z_Construct_UDelegateFunction_UGLSLogInfoObject_OnLogSelected__DelegateSignature, "OnLogSelected__DelegateSignature" }, // 1834305037
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSLogInfoObject_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Models_GLSLogInfoObject_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Models_GLSLogInfoObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSLogInfoObject, UGLSLogInfoObject::StaticClass, TEXT("UGLSLogInfoObject"), &Z_Registration_Info_UClass_UGLSLogInfoObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSLogInfoObject), 2597205031U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Models_GLSLogInfoObject_h_2331599372(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Models_GLSLogInfoObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Models_GLSLogInfoObject_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
