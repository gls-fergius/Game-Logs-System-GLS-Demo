...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UGLSLogItemBase_GetLogInfo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GLSLogItemBase_eventGetLogInfo_Parms, ReturnValue), Z_Construct_UScriptStruct_FGLSLogInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGLSLogItemBase_GetLogInfo_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_UGLSLogItemBase_GetLogInfo_Statics::NewProp_ReturnValue_MetaData) }; // 3359553873
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGLSLogItemBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGLSLogItemBase_GetLogInfo, "GetLogInfo" }, // 2700131713
		{ &Z_Construct_UFunction_UGLSLogItemBase_InitializeLogItem, "InitializeLogItem" }, // 3624241524
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSLogItemBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGLSLogItemBase_Statics::NewProp_EditableTextLog = { "EditableTextLog", nullptr, (EPropertyFlags)0x002408000008001c, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGLSLogItemBase, EditableTextLog), Z_Construct_UClass_UGLSMultiLineEditableText_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSLogItemBase_Statics::NewProp_EditableTextLog_MetaData), Z_Construct_UClass_UGLSLogItemBase_Statics::NewProp_EditableTextLog_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGLSLogItemBase_Statics::NewProp_LogModelPtr = { "LogModelPtr", nullptr, (EPropertyFlags)0x0024080000002014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGLSLogItemBase, LogModelPtr), Z_Construct_UClass_UGLSLogInfoObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSLogItemBase_Statics::NewProp_LogModelPtr_MetaData), Z_Construct_UClass_UGLSLogItemBase_Statics::NewProp_LogModelPtr_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGLSLogItemBase_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UGLSLogItemBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UUserObjectListEntry_NoRegister, (int32)VTABLE_OFFSET(UGLSLogItemBase, IUserObjectListEntry), false },  // 3135978134
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLSLogItemBase_Statics::InterfaceParams) < 64);
	...
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSLogItemBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSLogItemBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSLogItemBase, UGLSLogItemBase::StaticClass, TEXT("UGLSLogItemBase"), &Z_Registration_Info_UClass_UGLSLogItemBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSLogItemBase), 2011509387U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSLogItemBase_h_338028320(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSLogItemBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSLogItemBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
