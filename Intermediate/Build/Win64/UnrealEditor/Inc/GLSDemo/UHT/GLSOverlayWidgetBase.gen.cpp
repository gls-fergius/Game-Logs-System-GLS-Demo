...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::NewProp_InterfaceArray = { "InterfaceArray", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UGLSOverlayWidgetBase, InterfaceArray), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::NewProp_InterfaceArray_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::NewProp_InterfaceArray_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UGLSSaveSystemInterface_NoRegister, (int32)VTABLE_OFFSET(UGLSOverlayWidgetBase, IGLSSaveSystemInterface), false },  // 2226746826
		};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::ClassParams = {
		...
		0x00B010A1u,
		METADATA_PARAMS(Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGLSOverlayWidgetBase_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSOverlayWidgetBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSOverlayWidgetBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSOverlayWidgetBase, UGLSOverlayWidgetBase::StaticClass, TEXT("UGLSOverlayWidgetBase"), &Z_Registration_Info_UClass_UGLSOverlayWidgetBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSOverlayWidgetBase), 2729347565U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSOverlayWidgetBase_h_3310261227(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSOverlayWidgetBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSOverlayWidgetBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
