...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGLSSaveSubsystem_Statics::NewProp_SaveData = { "SaveData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UGLSSaveSubsystem, SaveData), Z_Construct_UScriptStruct_FGLSSaveData, METADATA_PARAMS(Z_Construct_UClass_UGLSSaveSubsystem_Statics::NewProp_SaveData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGLSSaveSubsystem_Statics::NewProp_SaveData_MetaData)) }; // 2639141417
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGLSSaveSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGLSSaveSubsystem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGLSSaveSubsystem_Statics::Class_MetaDataParams))
	};
	...
	UGLSSaveSubsystem::~UGLSSaveSubsystem() {}
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Subsystems_GLSSaveSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Subsystems_GLSSaveSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSSaveSubsystem, UGLSSaveSubsystem::StaticClass, TEXT("UGLSSaveSubsystem"), &Z_Registration_Info_UClass_UGLSSaveSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSSaveSubsystem), 2410484027U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Subsystems_GLSSaveSubsystem_h_2338865994(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Subsystems_GLSSaveSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_2_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_Subsystems_GLSSaveSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
