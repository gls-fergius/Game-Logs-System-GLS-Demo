...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_GLSDemo_GeneratedEntryWidgetDelegate__DelegateSignature_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_GLSDemo_eventGeneratedEntryWidgetDelegate_Parms, Widget), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GLSDemo_GeneratedEntryWidgetDelegate__DelegateSignature_Statics::NewProp_Widget_MetaData), Z_Construct_UDelegateFunction_GLSDemo_GeneratedEntryWidgetDelegate__DelegateSignature_Statics::NewProp_Widget_MetaData) };
...
void FGeneratedEntryWidgetDelegate_DelegateWrapper(const FMulticastScriptDelegate& GeneratedEntryWidgetDelegate, UObject* Model, UUserWidget* Widget)
{
	...
	struct Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSListView_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSListView_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLSListView, UGLSListView::StaticClass, TEXT("UGLSListView"), &Z_Registration_Info_UClass_UGLSListView, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLSListView), 2070938769U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSListView_h_2393062954(TEXT("/Script/GLSDemo"),
		Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSListView_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_builds_gls_demo_6_5_3_HostProject_Plugins_GameLogsSystemDemo_Source_GLSDemo_Public_UI_GLSListView_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
